...
#else
typedef enum	{Ident_1, Ident_2 = 10000, Ident_3, Ident_4, Ident_5} Enumeration;
#endif
...
typedef int	Arr_1_Dim[51];
typedef int	Arr_2_Dim[51][51];
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  // fprintf(stderr, "\n");
  // fprintf(stderr, "Dhrystone Benchmark, Version %s\n", Version);
  if (Reg)
  {
    // fprintf(stderr, "Program compiled with 'register' attribute\n");
  }
  else
  {
    // fprintf(stderr, "Program compiled without 'register' attribute\n");
  }
  // fprintf(stderr, "Using %s, HZ=%d\n", CLOCK_TYPE, HZ);
  // fprintf(stderr, "\n");

  Done = false;
  while (!Done) {
    // fprintf(stderr, "Trying %d runs through Dhrystone:\n", Number_Of_Runs);
